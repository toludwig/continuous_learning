...
class ClusterSFGPI():
    """
    A variant of SFGPI, in which SFs are not stored for each task,
    but only for clusters of tasks.
    These clusters are formed based on the similarity of task weights
    or the corresponding policies. TODO how are policies / SFs compared?
    """
    ...
    def __init__(self, n_states, n_actions, n_features,
        ...
        self.tasks = [] # list of centroid task vectors
